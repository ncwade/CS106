...
public class HashIntSet {
    ...
    public void addAll(HashIntSet set2) {
    	for(int entries = 0; entries < set2.size; entries++) {
    		this.add(set2.elementData[entries].data);
    	}
    }

    // Added for homework problem 4
    public void removeAll(HashIntSet set2) {
    	for(int entries = 0; entries < set2.size; entries++) {
    		this.remove(set2.elementData[entries].data);
    	}
    }
